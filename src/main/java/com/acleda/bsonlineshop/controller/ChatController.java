...
public class ChatController {
    ...
    @Operation(summary = "List chat rooms", description = "Rooms visible to the current user role (filtered by allowedRoles on each room).")
    @GetMapping("/rooms")
    ...
    @Operation(summary = "List chat messages", description = "Paginated messages in a chat room, oldest first.")
    ...
    @Operation(summary = "Send chat message", description = "Post a message to a room; sender is derived from the authenticated user.")
